...
export class IntegradorService {
  ...
  public obtenerHojaDeVida(username:String): Observable<HojaDeVidaDto>{
    return this.httpClient.get<HojaDeVidaDto>(`${this.orquestadorURL}/hojas-de-vidas/${username}`);
  }

  public corregirHojaDeVida(formulario: HojaDeVidaDto): Observable<any>{
    return this.httpClient.put(`${this.orquestadorURL}/hojas-de-vidas/corregir-datos`, formulario);
  }
